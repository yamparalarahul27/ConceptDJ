        ...
        <div className="max-w-4xl mx-auto py-20 px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Link href="/pro-pnl-tracker" className="group block">
                    <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 hover:border-purple-500/50 transition-all duration-300 h-full relative overflow-hidden">
                        ...
                        <div className="mb-4">
                            <span className="inline-block px-3 py-1 bg-purple-500/20 text-purple-300 text-xs font-mono rounded-full border border-purple-500/20">
                                ANALYTICS v2
                            </span>
                        </div>
